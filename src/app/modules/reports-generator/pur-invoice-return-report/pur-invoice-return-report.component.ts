...
@Component({
  selector: 'app-pur-invoice-return-report',
  standalone: true,
  ...
  templateUrl: './pur-invoice-return-report.component.html',
  styleUrl: './pur-invoice-return-report.component.scss'
})
export class PurInvoiceReturnReportComponent  implements OnInit {
    ...
    onGenerate() {
        this._ReportService.getPurchaseInvoiceReturnReport(this.invoiceNo,
            this.supplierID,
            this.fromDate,
    ...
    async onPrintReport() {
        ...
        this._pdfService.print(docDefinition, 'PurchaseReturnInvoice.pdf');
    }
    ...
    async onPdfGenerate() {
        ...
        this._pdfService.generatePdf(docDefinition, 'PurchaseReturnInvoice.pdf');
    }
