...
@Component({
    selector: 'app-payment-made-report',
    standalone: true,
    imports: [
        CommonModule,
        FormsModule,
    ...
    templateUrl: './payment-made-report.component.html',
})
export class PaymentMadeReportComponent {
    ...
    onGenerate(): void {
        this._ReportService.getPaymentMadeReport(this.fromDate, this.endDate).subscribe({
            next: (res: any) => {
                this.records = res;
