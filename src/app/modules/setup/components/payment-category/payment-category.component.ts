...
export class PaymentCategoryComponent extends BaseComponent<PaymentCategory, PaymentCategoryComponent> {
    constructor(
        ...
        this.setControllerName(apiUrls.paymentCategoryController);
        this.setFormTitle(componentRegister.paymentCategory.Title);
    }
    ...
    public override InitializeObject(): void {
        this.formData = new PaymentCategory();
    }

    override ValidateBeforeSave(formData: PaymentCategory): boolean {
        this.validation = [];
