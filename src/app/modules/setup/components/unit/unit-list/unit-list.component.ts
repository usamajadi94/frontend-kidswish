...
export class UnitListComponent extends BaseRoutedComponent {
    private modalService = inject(ModalService);
    private _listService = inject(ListService);
    private _exportService = inject(ExportService);
    title: string = componentRegister.unit.Title;
    isVisible: boolean = false;
    columns = [
        { header: 'Name', name: 'Name', isSort: true, isFilterList: true, type: 'text' },
        { header: 'Symbol', name: 'Symbol', isSort: true, isFilterList: true, type: 'text' },
        { header: 'Active', name: 'IsActive', isSort: true, isFilterList: true, type: 'text' },
    ...
    getData() {
        this._listService.getUnit().subscribe({
