...
templateUrl: './vehicle-information-list.component.html',
  styleUrl: './vehicle-information-list.component.scss'
})
export class VehicleInformationListComponent extends BaseRoutedComponent {
 private modalService = inject(ModalService);
  private _listService = inject(ListService);
  title: string = componentRegister.vehicle.Title;
  ...
  getData() {
    this._listService.getVehicleInformation().subscribe({
      next: (res: any) => {
        this.data = res;
      },
      error: (err) => {
